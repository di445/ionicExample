...
.controller('AppCtrl', function($scope, $ionicModal, $timeout, $localStorage, $ionicPlatform, $cordovaCamera, $cordovaImagePicker) {
  ...
  $scope.doRegister = function() {
    ...
    // Simulate a server delay. Remove this and replace with your registration
    // code if using a real server
    $timeout(function() {
      $scope.closeRegister();
    }, 1000);
  };
  ...
  $scope.doReserve = function() {
    ...
    // Simulate a server delay. Remove this and replace with your reservation
    // code if using a real server
    $timeout(function() {
      $scope.closeReserve();
    }, 1000);
...
.controller('MenuController', ['$scope', 'dishes', 'favoriteFactory','baseURL', '$ionicListDelegate', '$ionicPlatform', '$cordovaLocalNotification', '$cordovaToast', function($scope, dishes, favoriteFactory, baseURL, $ionicListDelegate, $ionicPlatform, $cordovaLocalNotification, $cordovaToast) {
  ...
  $scope.addFavorite = function(index) {
    ...
    notificateFavoriteAdded($ionicPlatform, $cordovaLocalNotification, $cordovaToast, $scope.dishes[index].name);
  };
}])
...
function($scope, $stateParams, dish, menuFactory, favoriteFactory, baseURL, $ionicPopover, $ionicModal, $ionicPlatform, $cordovaLocalNotification, $cordovaToast) {
  ...
  $scope.addFavorite = function() {
    ...
    notificateFavoriteAdded($ionicPlatform, $cordovaLocalNotification, $cordovaToast, $scope.dish.name);
    $scope.popover.hide();
  };
...
'baseURL', '$ionicListDelegate', '$ionicPopup', '$ionicLoading', '$timeout', '$ionicPlatform', '$cordovaVibration',
...
function notificateFavoriteAdded($ionicPlatform, $cordovaLocalNotification, $cordovaToast, dishName) {
  $ionicPlatform.ready(function() {
